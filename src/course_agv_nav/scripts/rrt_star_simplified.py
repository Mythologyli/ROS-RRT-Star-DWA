...
class RRTStarSimplified:
    ...
    def nearest(self, node: Node) -> Node:
        ...
        min_node = None
        for exist_node in reversed(self.nodes):
            distance = RRTStarSimplified.distance(node, exist_node)
    ...
    def find_neighbors(self, center_node: Node) -> List[Node]:
        ...
        for node in reversed(self.nodes):
            if RRTStarSimplified.distance(node, center_node) <= self.area_radius:
    ...
    def distance_from_start(self, cur_node: Node):
        ...
        while cur_node.parent is not None:
            total_distance += RRTStarSimplified.distance(cur_node, cur_node.parent)
    ...
    def plan(self,
        ...
        for i in range(self.max_iteration_times):
            ...
            if self.is_route_no_collision(nearest_node, new_node):
                ...
                if RRTStarSimplified.distance(new_node, goal_node) < self.plan_robot_radius:
